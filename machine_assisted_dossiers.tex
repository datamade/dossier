...
that a well designed system should possess.

\section{Scope Conditions}
Knowledge management systems trade off between flexibility and
...
In the full paper, we will provide examples from all these domains.
